...
class TargetManager:
    ...
    async def get_targets_by_type(
        ...
        """
        return [
            target for target in self.targets.values() if target.target_type == target_type
        ]
    ...
    async def clear_all_targets(self) -> None:
        """清除所有目标."""
        self.targets.clear()
